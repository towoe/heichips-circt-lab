...
run-chisel-simple:
	...
	../circt/build/bin/circt-opt -load-pass-plugin=build/CombAddOptimize.so -pass-pipeline='builtin.module(reduce-comb-add-width)' example-add-gen/AddSimple-lowered.mlir > example-add-gen/AddSimple-optimized.mlir
...
run-chisel-uneven-addition:
	...
	../circt/build/bin/circt-opt -load-pass-plugin=build/CombAddOptimize.so -pass-pipeline='builtin.module(reduce-comb-add-width)' example-add-gen/UnevenAddition-lowered.mlir > example-add-gen/UnevenAddition-optimized.mlir
